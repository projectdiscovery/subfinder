...
func ParseOptions() *Options {
	...
	flagSet.CreateGroup("rate-limit", "Rate-limit",
		...
		flagSet.RateLimitMapVarP(&options.RateLimits, "rate-limits", "rls", defaultRateLimits, "maximum number of http requests to send per second for providers in key=value format (-rls hackertarget=20/m)", goflags.NormalizedStringSliceOptions),
