...
We're extremely open to pull requests, if you wish something feel free to develop it and push it to here. If you're unable to code something, please raise it as an issue and if we think it has benefit to the community we'll look into developing it for you.
